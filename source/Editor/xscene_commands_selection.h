#ifndef XSCENE_COMMANDS_SELECTION_H
#define XSCENE_COMMANDS_SELECTION_H
#pragma once

// Selection commands - phase 1 of the command/undo plan, the simplest slice:
...
// "Make Prefab" - see scene_state's own comment) and the two existing UI behaviors already
...
{
    // ParseSceneGuid/FormatSceneGuid moved to xscene_command_context.h - shared with
    // xscene_commands_property_edit.h, not selection-specific.
...
#endif // XSCENE_COMMANDS_SELECTION_H
