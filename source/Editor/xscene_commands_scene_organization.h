#ifndef XSCENE_COMMANDS_SCENE_ORGANIZATION_H
#define XSCENE_COMMANDS_SCENE_ORGANIZATION_H
#pragma once

// InstantiatePrefab / MoveToFolder - gap #5 of the command/undo known-gaps list ("half the editor
...
// NOT addressed here: Duplicate doesn't exist in the editor today (nothing to wrap), and Make
...
namespace xscene::commands
{
    ...
    // "New Folder"/"Delete Folder" (ShowCreateMenuItems, xscene_create_menu.h; the Folder row's
    // own context menu AND its "X" button, the Level tree panel) still mutated Scene.m_Folders
    ...
    // create_entity_cmd already established (xscene_commands_entity_lifecycle.h), for the same
    // Redo-determinism reason.
    //================================================================================================
    struct create_folder_cmd : scene_command
    {
    ...
    //================================================================================================
    // DeleteFolder - mirrors xscene::DeleteFolder's own "purely organizational, never deletes content"
    // contract exactly (xscene_entity_inspector_bridge.h): the deleted folder's member entities AND any child
    ...
    //================================================================================================
    struct delete_folder_cmd : scene_command
    {
        delete_folder_cmd(xundo::system& System, void* pDataBase) noexcept : scene_command(System, "DeleteFolder", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
    ...
    struct instantiate_prefab_cmd : scene_command
    {
    ...
    //================================================================================================
    // MoveToFolder - mirrors every existing xscene::ReparentEntityIntoFolder drag-drop call site
    ...
    //================================================================================================
    struct move_to_folder_cmd : scene_command
    {
        move_to_folder_cmd(xundo::system& System, void* pDataBase) noexcept : scene_command(System, "MoveToFolder", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
        ...
        void BackupCurrenState(xundo::undo_file& File) noexcept override
        {
            ...
            const auto OldFolder = xscene::FindFolderContaining(*pScene, static_cast<xecs::scene::permanent_id>(Id));
        ...
        void Undo(xundo::undo_file& File) noexcept override
        {
            ...
            xscene::ReparentEntityIntoFolder(*pScene, static_cast<xecs::scene::permanent_id>(Id), static_cast<xecs::scene::folder_id>(OldFolder));
...
#endif // XSCENE_COMMANDS_SCENE_ORGANIZATION_H
